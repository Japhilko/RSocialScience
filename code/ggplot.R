...
#' 
## ----message=F,eval=internet---------------------------------------------
qmap("Mannheim")

#' 
## ----echo=F,message=F,warning=F,cache=T,eval=internet--------------------
...
#' ## ggmap - terrain map
#' 
## ----message=F,cache=T,eval=internet-------------------------------------
...
#' 
## ----warning=F,message=F,eval=internet-----------------------------------
MA_map <- qmap('Mannheim', 
               zoom = 14,
               maptype="toner",
               source="stamen")
...
#' 
## ----echo=F,message=F,warning=F,eval=internet----------------------------
...
#' 
## ----echo=F,message=F,eval=internet--------------------------------------
...
#' 
## ----cache=T,message=F,eval=internet-------------------------------------
revgeocode(c(48,8))
...
#' 
## ----message=F,warning=F,eval=internet-----------------------------------
...
#' 
## ----message=F,warning=F,cache=T,eval=internet---------------------------
from <- "Mannheim Hbf"
to <- "Mannheim B2 , 1"
